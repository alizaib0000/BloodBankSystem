...
def features():
    ...
    return render_template('features.html', total_donations=total_donations, donation_stats=donation_stats)
...
@app.route('/about')
def aboutus():
    return render_template('about.html')  # Your About us file name
